...
const legacyRedirects: ReadonlyArray<LegacyRedirect> = [
	...
	{ from: '/hjalp', to: 'contact', locale: 'sv' },
	{ from: '/hjalp/asic', to: 'contact', locale: 'sv' },
	{ from: '/hjalp/mems', to: 'contact', locale: 'sv' },
	{ from: '/hjalp/mikrostrukturer', to: 'contact', locale: 'sv' },
	{ from: '/hjalp/sensorer', to: 'contact', locale: 'sv' },
	{ from: '/hjalp/vanliga-fragor', to: 'contact', locale: 'sv' },
	{ from: '/hjalp/wafer', to: 'contact', locale: 'sv' },
	{ from: '/kunskapsbank', to: 'contact', locale: 'sv' },
	{ from: '/knowledge-bank', to: 'contact', locale: 'sv' },
	{ from: '/usen/help', to: 'contact', locale: 'en' },
	{ from: '/usen/help/asic', to: 'contact', locale: 'en' },
	{ from: '/usen/help/mems', to: 'contact', locale: 'en' },
	{ from: '/usen/help/mikrostrukturer', to: 'contact', locale: 'en' },
